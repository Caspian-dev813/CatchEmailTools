...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        pushButton->setGeometry(QRect(30, 240, 101, 32));
        ...
        setmod = new QComboBox(Widget);
        setmod->addItem(QString());
        setmod->addItem(QString());
        setmod->setObjectName("setmod");
        setmod->setGeometry(QRect(510, 430, 141, 30));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        setmod->setItemText(0, QCoreApplication::translate("Widget", "Microsoft Edge", nullptr));
        setmod->setItemText(1, QCoreApplication::translate("Widget", "Google Chrome", nullptr));
